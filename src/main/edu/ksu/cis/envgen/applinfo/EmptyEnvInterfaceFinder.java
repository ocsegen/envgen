...
//import edu.ksu.cis.envgen.analysis.cg.EnvCallGraphCHA;
//import edu.ksu.cis.envgen.analysis.cg.EnvCallGraphIndus;
//import edu.ksu.cis.envgen.analysis.cg.EnvCallGraphSpark;
...
//	protected Properties properties;
	...
	public EmptyEnvInterfaceFinder(){
	...
	public void findMissingComponents() {
		...
		for (Iterator<SootClass> it = unit.getClasses().iterator(); it.hasNext();) {
			...
			if (unitAnalysis) {
				...
				logger.info("unit methods: "+methods);
	...
	protected void envCheckInvokeExpr(
		...
		if (expr instanceof InstanceInvokeExpr) {
			...
			if (receiverType instanceof RefType) {
				...
				targets = hierarchy.resolveAbstractDispatch(declClass, invokeMethod);
